...
return(
        ...
        <div className='keypoints'>
          ...
          <p>The one-stop solution for all your educational needs, crafted for students, by students. We bring you a rich and varied collection of notes ready for you to devour.</p>
        </div>
      </div>
);
}
